...
This program creates a record of every network connection on a system and generates a log that contains the process name that initiated the connection. This data has potential to assist SOC/IR teams in incident response or threat hunting.    
```
Log Sample:
